...
const translations = {
    'fi': {
        ...
        'ohje': 'Klikkaamalla kuvaa kunkin projektin kohdalla, pääset tutustumaan siihen tarkemmin Githubissa.',
        'website': 'VERKKOSIVUT',
    ...
    'en': {
        ...
        'ohje': 'By clicking the image of each project, you can explore it further on Github.',
        'website': 'WEBSITES',
